    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if(!$model->save()){
                ...
                yii::$app->session->setFlash('flashMessage', ['type' => 'error', 'message' => Module::t('note', 'Note Not Saved' )]);
